...
from utils.human_voice_transcriber.whisper.initialize_whisper import initialize_whisper_model
from silero_vad import (load_silero_vad, read_audio, get_speech_timestamps, save_audio, VADIterator, collect_chunks)
from utils.human_voice_transcriber.whisper.record_live import record_audio
        ...
        if voice_detected.lower() == 'true':                
            ...
            while True:
                ...
                if voice_detected.lower() == 'true' and pause_detected.lower() == 'false':
                    if user_input:
                        user_input = f'{user_input}... [Still Speaking]'
